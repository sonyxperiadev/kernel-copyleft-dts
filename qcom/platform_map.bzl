_platform_map = {
    ...
    "asahi-cdb-generic": {
        ...
        "dtbo_list": [
            {"name": "pineapple-asahi-cdb-overlay.dtbo"},
            {"name": "pineapple-dpm-overlay.dtbo"},
        ],
    ...
    "asahi-cdb-ets": {
        ...
        "dtbo_list": [
            {"name": "pineapple-asahi-cdb_ets-overlay.dtbo"},
            {"name": "pineapple-dpm-overlay.dtbo"},
        ],
        "binary_compatible_with": ["cliffs"],
    },
    "pdx245-generic": {
        ...
        "dtbo_list": [
            {"name": "pineapple-asahi-pdx245_generic-overlay.dtbo"},
            {"name": "pineapple-dpm-overlay.dtbo"},
        ],
        "binary_compatible_with": ["cliffs"],
    },
    "pdx245-ets": {
        ...
        "dtbo_list": [
            {"name": "pineapple-asahi-pdx245_ets-overlay.dtbo"},
            {"name": "pineapple-dpm-overlay.dtbo"},
        ],
        "binary_compatible_with": ["cliffs"],
    },
    "pdx245-jp": {
        ...
        "dtbo_list": [
            {"name": "pineapple-asahi-pdx245_j-overlay.dtbo"},
            {"name": "pineapple-dpm-overlay.dtbo"},
        ],
        "binary_compatible_with": ["cliffs"],
    },
